[Deployed Portfolio site on Zeit](https://zeit-porfolio.adnancodes.now.sh/)

[Deployed Build Week App on Zeit as well](https://front-end-build-week-utms.adnancodes.now.sh/)
